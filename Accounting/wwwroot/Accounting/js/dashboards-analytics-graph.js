...
renderGroupedBarChart({
    ...
    endpoint: "/Dashboards/GetAllDataVoucher",
    xField: "voucher",
    seriesConfig: [
        { name: "Debit", field: "totalDebit", color: "#FF9800" },
        { name: "Credit", field: "totalCredit", color: "#607D8B" }
    ],
    stacked: true,
    height: 420,
    valuePrefix: "Rs. "
...
// valuePrefix: "Rs. "
//});
// PageJS File Function call - Modified
renderGroupedBarChart2({
    containerId: "voucherChart",
    chartTitle: "Voucher Summary",
    endpoint: "/Dashboards/GetAllDataVoucher2",
    xField: "voucher",
    seriesConfig: [
        { name: "Debit", field: "totalDebit", color: "#FF9800" },
        { name: "Credit", field: "totalCredit", color: "#607D8B" }
