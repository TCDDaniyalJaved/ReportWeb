                ...
                rows.each(function () {
                    ...
                    groupByFields.forEach((field, index) => {
                        ...
                        if (lastGroup[index] !== value) {
                            $(this).before(`
                        <tr class="table-secondary fw-semibold group-row level-${index}">
                    ...
                    `);
                            ...
                            // Reset lower levels
                            for (let j = index + 1; j < groupByFields.length; j++) lastGroup[j] = null;
                        }
                    });
                });
            }
