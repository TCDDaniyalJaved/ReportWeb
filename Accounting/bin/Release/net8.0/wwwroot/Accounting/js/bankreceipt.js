...
$(document).ready(async () => {
    ...
    initDefaultPageLengthEditor({
        reportKey: 'BankReceipt',
        viewName: 'BankReceiptView',
        isDefault: true,
    ...
    function loadFavorites() {
        $.get('/Accounting/Report/GetUserReportViews', { reportKey: 'BankReceipt' }, function (data) {
