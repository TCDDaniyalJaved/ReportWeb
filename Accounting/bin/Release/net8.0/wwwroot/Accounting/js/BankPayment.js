...
$(document).ready(async () => {
    ...
    initDefaultPageLengthEditor({
        reportKey: 'BankPayment',
        viewName: 'BankPaymentView',
        isDefault: true,
    ...
    function loadFavorites() {
        $.get('/Accounting/Report/GetUserReportViews', { reportKey: 'BankPayment' }, function (data) {
